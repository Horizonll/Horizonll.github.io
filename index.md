...
I am an undergraduate at [Tsinghua University](https://www.tsinghua.edu.cn/) and will join [Embodied Decision Intelligence Lab (EDI Lab)](https://thusigs-edi-lab.github.io/) as a Ph.D. student in Fall 2027, advised by [Prof. Chao Yu](https://zoeyuchao.github.io/). Previously, I worked with [Prof. Gao Huang](https://gaohuang-net.github.io/) at [LEAP Lab](https://www.leaplab.ai/) on foundation model architectures and Test-Time Training, and collaborated with [Prof. Xiaozhi Wang](https://bakser.github.io/) on RLVR.
